...
public class InformationTracker {
    ...
    public static final int SIGNATURE_TRACKER_DEEP_2 = 16;
    ...
    private StandardTransactionOutput processSnapshot(DataSnapshot snap, int id) {
        ...
        switch(id) {
            case SIGNATURE_TRACKER:
                ...
                if(!this.special_info.equals("view")) {
                    int con = 0;
                    ...
                    for(DataSnapshot d: snap.getChildren()) {
                        sig_tr_o.getContent().put(d.getKey(), (String) d.child("name").getValue());
                    }
                }
            ...
            case PETITIONS_TRACKER:
                ...
                return temp;
            case SIGNATURE_TRACKER_DEEP_2:
                rep = snap.getValue(TrackerRepresentation.SignatureRepresentation.class);
                StandardTransactionOutput aa;
                if(rep != null) {
                    aa = rep.extractGeneralizedOutput();
                    aa.setResultType(SIGNATURE_TRACKER_DEEP_2);
                }
                else {
                    aa = StandardTransactionOutput.nullTransactionOutput();
                }
                return aa;
        }
